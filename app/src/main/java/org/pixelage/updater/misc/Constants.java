...
public final class Constants {
    ...
    public static final String PROP_RELEASE_TYPE = "ro.pixelage.releasetype";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "pixelage.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "pixelage.updater.uri";
